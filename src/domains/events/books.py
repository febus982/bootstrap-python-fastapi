...
class BookUpdatedV1(BaseEvent):
    type: typing.Literal["book.created.v1"] = type_field("book.updated.v1")
    dataschema: str = dataschema_field("book.updated.v1")
            ...
            "examples": [
                {
                    ...
                    "dataschema": "book.updated.v1/some_event",
                    "datacontenttype": "text/xml",
                    "subject": "123",
                    "data": {"book_id": 0, "title": "string", "author_name": "string"},
                    "id": "A234-1234-1234",
